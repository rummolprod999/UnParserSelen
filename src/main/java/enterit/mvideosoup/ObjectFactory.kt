...
class ObjectFactory {
     ...
     *
     */
    fun createDTGetProcListResponse(): DTGetProcListResponse {
        return DTGetProcListResponse()
    }
     ...
     *
     */
    fun createDTGetProcListResponseTenders(): DTGetProcListResponse.Tenders {
        return DTGetProcListResponse.Tenders()
    }
     ...
     *
     */
    fun createDTGetProcListResponseHeader(): DTGetProcListResponse.Header {
        return DTGetProcListResponse.Header()
    }
     ...
     *
     */
    fun createDTGetProcListResponseTendersItem(): DTGetProcListResponse.Tenders.Item {
        return DTGetProcListResponse.Tenders.Item()
    }
     ...
     *
     */
    fun createDTGetProcListResponseHeaderCompany(): DTGetProcListResponse.Header.Company {
        return DTGetProcListResponse.Header.Company()
    }
     ...
     *
     */
    fun createDTGetProcListResponseHeaderSource(): DTGetProcListResponse.Header.Source {
        return DTGetProcListResponse.Header.Source()
    }
    ...
    fun createMTGetProcListRequest(value: String): JAXBElement<String> {
        return JAXBElement(_MTGetProcListRequest_QNAME, String::class.java, null, value)
    }
