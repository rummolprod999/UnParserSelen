...
class TenderPnsh(
    ...
    ITender {
    init {
        etpName = "ГК «Нефтьсервисхолдинг»"
        etpUrl = "https://tender.pnsh.ru/"
    }
            ...
            fun(con: Connection) {
                ...
                lots.forEachIndexed { index, lot ->
                    ...
                    val insertLot =
                        con
                            .prepareStatement(
                                "INSERT INTO ${Prefix}lot SET id_tender = ?, lot_number = ?, currency = ?, lot_name = ?",
                                Statement.RETURN_GENERATED_KEYS,
                            ).apply {
                                setInt(1, idTender)
                                setInt(2, LotNumber)
                    ...
                    if (purobj1.isEmpty() && purobj2.isEmpty()) {
                        ...
                        insertPurObj.setString(3, lotName)
