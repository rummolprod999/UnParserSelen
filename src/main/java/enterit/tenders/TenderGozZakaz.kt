...
class TenderGosZakaz(val tn: CrimeaBT) : TenderAbstract(), ITender {
    companion object TypeFz {
        const val typeFz = 126
    }

    init {
        etpName = "Тендеры Республики Беларусь"
        etpUrl = "http://goszakaz.by/"
    }
